...
<body>
    ...
    <div class="content">
      ...
      <span class="content_right">
        ...
        <!-- poster title -->
        <p id="poster-title" style="margin-top: 4vh;"> <?php //echo the_title();?> </p>
        <HR size="1px" color="#ffe6a0">
        <div class="textbox2">

          <!-- poster time -->
          <p id="p_text" class="date">
            <?php
        ...
        $is_multiple=True;
          endwhile;
            ...
            <div id="poster-title">還沒有發佈新活動海報喔！</div>
        <?php
        endif;
        wp_reset_postdata();
        ?>
            ...
            <div class="news_block_content">  
              ...
              $is_multiple=True;
                endwhile;
                  ...
                  <div id="poster-title">還沒發佈最新消息喔！</div>
              <?php
              endif;
              wp_reset_postdata();
              ?>
