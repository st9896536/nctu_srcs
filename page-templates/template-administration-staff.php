        ...
        <div class="inblock" style="width:73.875vw; margin-top: 3vh;">
            ...
            <span class="job_content" style="width:49vw; height:32vh; float:right;">
              <ol>
                ...
                <li>本所組織章程、定位、所教評會組織、升等辦法、獎助學金辦法及施行細則、招生試務工作小組組成辦法及考試資格審查辦法訂定與修訂。</li>
                <li>系所自我評鑑作業及大專校院系所評鑑作業。</li>
                <li>碩（碩甄試、一般入學考試及陸生、僑生、外籍生入學審查），博班（一般入學考試及僑生、外籍生入學審查）招生與外籍生獎學金審查工作。</li>
                <li>所教評會、所務會議聯絡、提案資料準備及簽辦。</li>
                <li>教師彈性薪資教學及研發資料系統維護申報，教育部建置全國教育資訊管理服務、總量管制系統及台經院問卷之資料庫填寫。</li>
                <li>本所空間及財產保管與報廢作業。</li>
                <li>國科會專題研究計畫線上彙整、變更作業。</li>
                <li>所長交辦事宜。</li>
              </ol>
            </span>
            <div class="line" style="margin-top:39.75vh; width:21vw;">
