...
<?php get_template_part('includes/sidebar-student-recruitment'); ?>
    ...
    <div class="main" style="width:72vw;">
      ...
      <div class="f_block">
        ...
        <div class="chinese-class">碩士班／博士班</div>
        <div class="chinese-extra" style="font-size: 0.8em; letter-spacing: 0em;">交通大學社會與文化研究所碩士班、博士班自100學年(2011年)起招收大陸地區學生，敬請您幫忙傳送給您的大陸朋友，歡迎陸生踴躍報考就讀！</div>
        <HR size="1px" style="margin-top:1.75vh; margin-bottom:2.25vh; width:66.5vw;">
        <div class="chinese-reg">報考時間自2014年2月11日至4月1日止。</div>
