  ...
  <div class="row">
    <div class="main">
      ...
      <div class="title_news" style="width:68.75vw; padding-bottom: 2vh; border-bottom: #000 solid 1px;">
        ...
        <div style="height:auto; width: 62vw; display: inline-block; vertical-align: top; padding-left: 1vw;">
      ...
      <div class="block2" style="margin-top:1.75vh; width:68.75vw;">
        ...
        <div style="display: inline-block; padding:1vh; width:5.5%"><HR size="1px"></div>

        <div class="place">交通大學人社二館106A研討室<br>Seminar room 106A, HA Building 2, Chiao Tung University, Hsinchu, Taiwan
        </div>


        <div class="button" style="margin-top:1vh; margin-bottom: 1vh; display: inline-block; margin-right:0.6vw;">
          <a href="" class="button_register">線上報名</a>
        </div>
        <div class="button" style="margin-top:1vh; margin-bottom: 1vh; display: inline-block;">
